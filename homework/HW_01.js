...
let myWeight = '175 lbs';
console.log(myWeight);
let myFavoriteLetter = 'h';
...
let a5 = 17;
sum = a1 + a2 + a3 + a4 + a5;
console.log('The average of the numbers is: ' +(sum / 5));
